...
def mesh_updater(n_nodes: int, strain_xx: float, strain_yy: float, strain_xy: float, hole_radius: float) -> pv.PolyData:
...
start_mesh = mesh_updater(21,0.03, -0.025, 0.025, 20)
...
pl.add_slider_widget(
    callback=lambda value: engine("n_nodes", int(value)),
    rng=[2,100],
    value=21,
